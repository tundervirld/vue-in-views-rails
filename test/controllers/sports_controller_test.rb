...
class SportsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sport" do
    assert_difference('Sport.count') do
      post sports_url, params: { sport: { description: @sport.description, name: @sport.name, state: @sport.state } }
    end
  ...
  test "should update sport" do
    patch sport_url(@sport), params: { sport: { description: @sport.description, name: @sport.name, state: @sport.state } }
